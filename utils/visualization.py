...
def plot_feature_importance(features, importances, top_n=10, figsize=(10, 8)):
    """
...
def plot_confusion_matrix(cm, class_names=['Negative', 'Positive'], figsize=(8, 6)):
    """
...
def create_performance_dashboard(predictions, labels, history=None, figsize=(14, 10)):
    ...
    for true, pred in zip(labels, binary_preds):
        cm[true, pred] += 1
